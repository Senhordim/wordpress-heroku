...
$swm_show_hide = array(
    "swm_search_box"            =>  __('Display Search Icon in Top Bar', 'swmtranslate' ),
    "swm_topbar_cart_icon"      =>  __('Display Cart Icon in Top Bar', 'swmtranslate' ),
    "swm_scroll_top_arrow"      =>  __('Display Scroll To Top Arrow Icon', 'swmtranslate' ),      
    "swm_breadcrumbs"           =>  __('Display Breadcrumbs', 'swmtranslate' ),
