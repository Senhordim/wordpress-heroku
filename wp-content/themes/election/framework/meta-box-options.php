...
********************************************************** */
	...
	$meta_boxes[] = array(		
		...
		'fields' => array(	
			...
			array(
				"name" => __('Page Title Background Color', 'swmtranslate'),									
				"id" => "{$prefix}meta_page_title_bg",
				"std" => '',
				"type" => "color",				
			),
			array(
				'name' => __( 'Background Color Opacity', 'swmtranslate' ),
				'id'   => "{$prefix}meta_page_title_bg_opacity",
				'type' => 'slider',
				'std'  => '80',
				'js_options' => array(
					'min'   => 0,
