...
$output .= '.swm_archives_page a,.search-list a,.swm_portfolio_title_section a,.swm_portfolio_title_section,.swm_horizontal_menu li a,a.swm_text_color,.swm_text_color a,a.page-numbers,.pagination_menu a span,.pf_quote p.pf_quote_text a { color:'. get_theme_mod('swm_body_sc_color','#606060') .' }';
$output .= '.swm_archives_page a:hover,.search-list a:hover,.icon_url a i.fa-link,a.swm_text_color:hover { color:'.$swm_primary_skin.'}';
...
$output .= 'h3.tribe-events-month-event-title a,#tribe-events-content .tribe-events-tooltip h4,.tribe-events-list .vevent.hentry h2 a:hover,a.tribe-events-read-more,a.tribe-events-read-more:hover { color:'.$swm_primary_skin.'; }';
