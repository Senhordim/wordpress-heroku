...
define('SWM_THEME_NAME', 'election');
	...
	function swm_load_scripts () {
		if ( !is_admin() ) {			
            ...
            $google_fonts_add_list = array(
                'family' => swm_output_google_font_url('swm_body_font_family','swm_body_font_weight','|',$swm_body_sf) . swm_output_google_font_url('swm_top_nav_font_family','swm_top_nav_font_weight','|',$swm_top_nav_sf) . swm_output_google_font_url('swm_headings_font_family','swm_headings_font_weight','',$swm_headings_sf),
                'subset' => $subsets,
            );          

            $protocol = is_ssl() ? 'https' : 'http';
            $get_google_font_families = add_query_arg( $google_fonts_add_list, $protocol . '://fonts.googleapis.com/css' );             
